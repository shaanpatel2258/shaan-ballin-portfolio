        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 w-8 h-8 bg-orange-500 rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-300">
                <div className="absolute inset-0 rounded-full border border-orange-800" />
                <div className="absolute top-0 left-1/2 w-px h-full bg-orange-800" style={{ transform: 'translateX(-50%)' }} />
                <div className="absolute top-1/2 left-0 w-full h-px bg-orange-800" style={{ transform: 'translateY(-50%)' }} />
              </div>
            </div>
          ))}
        </div>
